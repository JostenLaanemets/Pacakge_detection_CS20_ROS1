...
namespace Synexens
{
	...
	//@ return 错误码
	extern "C" SYSDK_DLL SYErrorCode GetHardWareFilterMode(unsigned int nDeviceID, bool& bHardwareFilterMode);

	//开启/关闭硬件滤波模式
	//@ param [in] nDeviceID 设备ID
	//@ param [in] bHardwareFilterMode 硬件滤波模式开启状态，true-开启硬件滤波模式，false-关闭硬件滤波模式
	//@ return 错误码
	extern "C" SYSDK_DLL SYErrorCode SetHardWareFilterMode(unsigned int nDeviceID, bool bHardwareFilterMode);

	//硬件滤波模式是否可用
	//@ param [in] nDeviceID 设备ID
	//@ param [in] bHaveHardwareFilterMode 硬件滤波模式可用标志，true-可用，false-不可用
	//@ return 错误码
	extern "C" SYSDK_DLL SYErrorCode HaveHardWareFilterMode(unsigned int nDeviceID, bool& bHaveHardwareFilterMode);
	...
	//@ return 错误码
	extern "C" SYSDK_DLL SYErrorCode GetTrailFilter(unsigned int nDeviceID, bool& bFilter);

	//开启/关闭拖影滤波
	//@ param [in] nDeviceID 设备ID
	//@ param [in] bFilter 拖影滤波开关，true-开启滤波，false-关闭滤波
	//@ return 错误码
	extern "C" SYSDK_DLL SYErrorCode SetTrailFilter(unsigned int nDeviceID, bool bFilter);
